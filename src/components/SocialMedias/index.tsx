...
import { MaterialCommunityIcons, FontAwesome5, Entypo, AntDesign } from "@expo/vector-icons"

const SocialMediaContainer = (props) => {
    return (
        <View style={{
            backgroundColor: props.color, width: 40, height: 40, borderRadius: 20, flexDirection: "row",
...
function index() {
    return (
        <View>
            ...
            <View style={{
                marginTop: "6%", marginBottom: "12%", borderWidth: 1.2, borderColor: "#FF3E55", height: 44, borderRadius: 22,
