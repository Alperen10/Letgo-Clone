 ...
 // console.log("The product is ",product)
  return (
    <View style={{borderColor:'#EAEAEA', borderWidth:2,shadowColor:'gray',shadowOpacity:0.12,padding:14, borderRadius:10,marginBottom:18,height:height*0.18}}>
      <View style={{ flexDirection: "row", alignItems: "center",paddingBottom:8,borderBottomWidth:1.5,borderBottomColor:'#dcdee0' }}>
        <Image
      ...
      <View style={{flexDirection:'row',justifyContent:'space-between',width:'74%',marginHorizontal:'13%',marginTop:8,alignItems:'center'}}>
